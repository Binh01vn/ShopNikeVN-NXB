                        ...
                        <div class="sp-img_area">
                            ...
                            "asNavFor": ".sp-img_slider-nav"
                                ...
                                <div class="single-slide orange">
                                    <img src="{{ asset('theme/client/assets/images/product/1-2.jpg') }}"
                                        alt="Kenne's Product Image">
                                </div>
                                ...
                                <div class="single-slide umber">
                                    <img src="{{ asset('theme/client/assets/images/product/2-2.jpg') }}"
                                        alt="Kenne's Product Image">
                                </div>
                                ...
                                <div class="single-slide golden">
                                    <img src="{{ asset('theme/client/assets/images/product/3-2.jpg') }}"
                                        alt="Kenne's Product Image">
                                </div>
                            </div>
