                ...
                <div class="section-title">
                    ...
                    <div class="product-tab">
                        <ul class="nav product-menu">
                            @foreach ($dataCtl as $itCtl)
                                @php
                                    $maxId = max($dataCtl->pluck('id')->toArray());
                                @endphp
                                <li>
                                    <a {!! $itCtl->id == $maxId ? 'class="active"' : '' !!} data-bs-toggle="tab" href="">
                                        <span>{{ $itCtl->name }}</span>
                                    </a>
                                </li>
                            @endforeach
                        </ul>
                                            ...
                                            <div class="product-desc_info">
                                                ...
                                                <div class="price-box">
                                                    <span class="new-price">
                                                        {{ number_format((int) $item->price_regular, 0, ',', '.') }}(VND)
                                                    </span>
