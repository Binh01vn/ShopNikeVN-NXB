        ...
        <div class="card-header">
            <div class="row flex-between-center">
                <div class="col-6 col-sm-auto d-flex align-items-center pe-0">
                    <h5 class="fs-9 mb-0 text-nowrap py-2 py-xl-0">List Catalogues</h5>
                </div>
                <div class="col-6 col-sm-auto ms-auto text-end ps-0">
                    ...
                    <div id="table-number-pagination-replace-element">
                        <a class="btn btn-falcon-default btn-sm" href="{{ route('admin.catalogues.create') }}">
                ...
                <table class="table table-sm mb-0 data-table fs-10"
                    ...
                    <thead class="bg-200">
                        <tr>
                            ...
                            <th class="text-900 sort pe-1 align-middle white-space-nowrap">Image</th>
                            ...
                            <th class="text-900 sort pe-1 align-middle white-space-nowrap text-center">Is Active</th>
                        ...
                        @foreach ($data as $item)
                            <tr class="btn-reveal-trigger">
                                ...
                                <td class="align-middle white-space-nowrap fw-semi-bold name">
                                    <a href="{{ route('admin.catalogues.show', $item->id) }}">{{ $item->name }}</a>
                                </td>
                                <td class="align-middle white-space-nowrap email">
                                    <img src="{{ Storage::url($item->cover) }}" alt="Error!" width="150px">
                                </td>
                                    ...
                                    <div class="dropstart font-sans-serif position-static d-inline-block">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end border py-2"
                                            ...
                                            <a class="dropdown-item"
                                                href="{{ route('admin.catalogues.show', $item->id) }}">View</a>
                                            <a class="dropdown-item"
                                                href="{{ route('admin.catalogues.edit', $item->id) }}">Edit</a>
