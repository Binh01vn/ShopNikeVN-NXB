...
@section('contents')
    ...
    <form class="row g-0" action="{{ route('admin.products.update', $model) }}" method="POST"
                ...
                <div class="card-body">
                    <div class="row gx-2">
                        ...
                        <div class="col-6 mb-3">
                            ...
                            <textarea class="form-control" name="material" id="material" rows="3">{{ $model->material }}</textarea>
                        </div>
                        <div class="col-12 mb-3">
                            <label class="form-label" for="user_manual">User manual:</label>
                            <textarea class="form-control" name="user_manual" id="user_manual" rows="2">{{ $model->user_manual }}</textarea>
                        </div>
                        <div class="col-12 mb-3">
            ...
            <div class="sticky-sidebar">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <select class="form-select" id="product-category" name="catalogue_id">
                                    @foreach ($catalogues as $id => $name)
                                        <option value="{{ $id }}" {{ $model->catalogue_id ? 'selected' : '' }}>
                                            {{ $name }}</option>
                                    @endforeach
                                </select>
                            </div>
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div class="row gx-2">
                            <div class="col-12 mb-4">
                                <img class="primary-img" src="{{ Storage::url($model->img_thumbnail) }}"
                                    alt="Kenne's Product Image" width="200px">
                            </div>
                            <div class="col-12 mb-4">
